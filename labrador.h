...
typedef struct {
  ...
  polx
      *u1; // outer commitment 1 (kappa1) or inner commitments (r*kappa) if tail
...
__attribute__((const)) int sis_secure(size_t rank, double norm);
#define init_comkey NAMESPACE(init_comkey)
__attribute__((visibility("default"))) void init_comkey(size_t n);
#define free_comkey NAMESPACE(free_comkey)
__attribute__((visibility("default"))) void free_comkey(void);
...
__attribute__((visibility("default"))) void free_witness(witness *wt);
