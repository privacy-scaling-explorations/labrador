...
__attribute__((const)) size_t extlen(size_t len, size_t deg);
...
__attribute__((visibility("hidden"))) void poly_ntt(poly *r, const poly *a,
                                                    const pdata *prime);
void polyvec_ntt(poly *r, const poly *a, size_t len, size_t stride,
                 const pdata *prime);
__attribute__((visibility("hidden"))) void poly_invntt(poly *r, const poly *a,
                                                       const pdata *prime);
