...
void poly_jlproj_add(int32_t out[256], const poly *in,
                     const uint8_t mat[256 * N / 8]) {
  int i;
  __m512i a, b, c, d;
  __m512i e, f, g, h;
  __m512i k, l, m, n;
  ...
  const __m512i vpermi2bidx = _mm512_set_epi8(
      95, 87, 79, 71, 94, 86, 78, 70, 93, 85, 77, 69, 92, 84, 76, 68, 91, 83,
      75, 67, 90, 82, 74, 66, 89, 81, 73, 65, 88, 80, 72, 64, 31, 23, 15, 7, 30,
      22, 14, 6, 29, 21, 13, 5, 28, 20, 12, 4, 27, 19, 11, 3, 26, 18, 10, 2, 25,
      17, 9, 1, 24, 16, 8, 0);

  /* Prepare 16 vectors containing all 16 signed combinations of 4 polynomial
   * coeffs that are 16 apart */
  ...
  a = _mm512_unpacklo_epi64(
      k,
      l); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  b = _mm512_unpackhi_epi64(
      k,
      l); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  c = _mm512_unpacklo_epi64(
      m,
      n); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  d = _mm512_unpackhi_epi64(
      m,
      n); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  e = _mm512_unpacklo_epi64(
      o,
      p); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  f = _mm512_unpackhi_epi64(
      o,
      p); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  g = _mm512_unpacklo_epi64(
      q,
      r); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  h = _mm512_unpackhi_epi64(
      q,
      r); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  k = _mm512_unpacklo_epi64(
      s,
      t); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  l = _mm512_unpackhi_epi64(
      s,
      t); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  m = _mm512_unpacklo_epi64(
      u,
      v); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  n = _mm512_unpackhi_epi64(
      u,
      v); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  o = _mm512_unpacklo_epi64(
      w,
      x); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  p = _mm512_unpackhi_epi64(
      w,
      x); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  q = _mm512_unpacklo_epi64(
      y,
      z); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
  r = _mm512_unpackhi_epi64(
      y,
      z); // ++++,+++-,++-+,++--,+-++,+-+-,+--+,+---,-+++,-++-,-+-+,-+--,--++,--+-,---+,----
...
void polyvec_jlproj_add(int32_t r[256], const poly *p, size_t len,
                        const uint8_t *mat) {
  size_t i;
...
static void jlproj_collapsmat32(int64_t *row, const uint8_t *mat, size_t len,
                                const int64_t alpha[32]) {
  size_t i;
  __m512i a, b, c, d;
  __m512i e, f, g, h;
  __m512i k, l, m, n;
  ...
  /* Prepare 8 pairs of vectors containing all 16 signed combinations of 4
   * challenge coeffs that are 8 apart */
...
static void expand_challenge(int64_t alpha[256],
  ...
  const __m512i vpermbidx = _mm512_set_epi8(
      -1, -1, -1, -1, -1, 23, 22, 21, -1, -1, -1, -1, -1, 20, 19, 18, -1, -1,
      -1, -1, -1, 17, 16, 15, -1, -1, -1, -1, -1, 14, 13, 12, -1, -1, -1, -1,
      -1, 11, 10, 9, -1, -1, -1, -1, -1, 8, 7, 6, -1, -1, -1, -1, -1, 5, 4, 3,
      -1, -1, -1, -1, -1, 2, 1, 0);
  for (i = 0; i < 256 / 8; i++) {
  ...
  const __m512i vpermbidx = _mm512_set_epi8(
      -1, -1, -1, 39, 38, 37, 36, 35, -1, -1, -1, 34, 33, 32, 31, 30, -1, -1,
      -1, 29, 28, 27, 26, 25, -1, -1, -1, 24, 23, 22, 21, 20, -1, -1, -1, 19,
      18, 17, 16, 15, -1, -1, -1, 14, 13, 12, 11, 10, -1, -1, -1, 9, 8, 7, 6, 5,
      -1, -1, -1, 4, 3, 2, 1, 0);
  for (i = 0; i < 256 / 8; i++) {
  ...
  const __m512i vpermbidx = _mm512_set_epi8(
      -1, -1, 47, 46, 45, 44, 43, 42, -1, -1, 41, 40, 39, 38, 37, 36, -1, -1,
      35, 34, 33, 32, 31, 30, -1, -1, 29, 28, 27, 26, 25, 24, -1, -1, 23, 22,
      21, 20, 19, 18, -1, -1, 17, 16, 15, 14, 13, 12, -1, -1, 11, 10, 9, 8, 7,
      6, -1, -1, 5, 4, 3, 2, 1, 0);
  for (i = 0; i < 256 / 8; i++) {
...
void polxvec_jlproj_collapsmat(polx *r, const uint8_t *mat, size_t len,
                               const uint8_t buf[256 * QBYTES]) {
  size_t i, j, k;
  __m512i f, g;
  ...
  __attribute__((aligned(64))) int64_t alpha[256];
  __attribute__((aligned(64))) int64_t raw[16 * N];
  polz t[16];
    ...
    for (i = 0; i < 16; i++) {
      for (j = 0; j < N / 8; j++) {
        ...
        for (k = 0; k < L - 1; k++) {
          ...
          _mm512_mask_compressstoreu_epi16(&t[i].limbs[k].c[8 * j], oneinfour,
                                           g);
        }
        _mm512_mask_compressstoreu_epi16(&t[i].limbs[L - 1].c[8 * j], oneinfour,
                                         f);
      }
    }
...
static inline int64_t _mm512_hsum_epi64(__m512i a) {
  __m256i t;
  __m128i u;
  t = _mm256_add_epi64(_mm512_castsi512_si256(a),
...
int64_t jlproj_collapsproj(const int32_t p[256],
                           const uint8_t buf[256 * QBYTES]) {
  int i;
  int64_t r, t;
  __attribute__((aligned(64))) int64_t alpha[256];
